    ...
    public class Main {
        ...
        public static void main(String[] args) {
            ...
            try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
                ...
                // Données de test
                stmt.executeUpdate("INSERT INTO DevData VALUES ('0','ALAMI', 'Lundi', 1)");
                stmt.executeUpdate("INSERT INTO DevData VALUES ('0','WAFI', 'Lundi', 2)");
                stmt.executeUpdate("INSERT INTO DevData VALUES ('0','SLAMI', 'Mardi', 9)");
                stmt.executeUpdate("INSERT INTO DevData VALUES ('0','ALAMI', 'Mardi', 3)");
                stmt.executeUpdate("INSERT INTO DevData VALUES ('0','WAFI', 'Mardi', 4)");
                stmt.executeUpdate("INSERT INTO DevData VALUES ('0','SLAMI', 'Mercredi', 2)");
                ...
                String devRecherche = sc.nextLine().toUpperCase();
                ...
                // Statistique 5 : moyenne de scripts par jour
                System.out.println("\n--- Moyenne de scripts par jour ---");
                try (ResultSet rs = stmt.executeQuery(
                        "SELECT Jour, AVG(NbScripts) AS Moyenne " +
                                "FROM DevData GROUP BY Jour"
                )) {
                    while (rs.next()) {
                        String jour = rs.getString("Jour");
                        double moyenne = rs.getDouble("Moyenne");
                        System.out.println(jour + " | moyenne : " + moyenne);
                    }
                }
